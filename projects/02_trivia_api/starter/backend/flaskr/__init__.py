...
def create_app(test_config=None):
  ...
  def create_or_search_question():
    ...
    if searchTerm:
      ...
      # actually would have liked to do this check within the model and not null constraints in the db,
      # but this would require a new migration and a try/except block within insert(), hence I was to lazy.
